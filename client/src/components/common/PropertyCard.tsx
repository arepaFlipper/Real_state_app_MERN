...
const PropertyCard = ({ id, title, location, price, photo }: PropertyCardProps) => {
  return (
    <Card component={Link} to={`/properties/${id}`} sx={{ maxWidth: '330px', padding: '10px', '&:hober': { boxShadow: '0 22px 45px 2px rgba(176, 176, 176, 0.1)' }, textDecoration: 'none', cursor: 'pointer' }} elevation={0} >
      <CardMedia component="img" height={210} image={photo} alt="card image" sx={{ borderRadius: '10px', aspectRatio: "1/1" }} />
