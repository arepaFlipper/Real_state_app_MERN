    ...
    <Box>
      ...
      <Box mt="20px" borderRadius="15px" padding="20px" bgcolor="#FCFCFC">
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 2.5, }}>
          <img width={340} height={320} alt="abstract" className="my_profile-bg" src="https://images.unsplash.com/photo-1618005198919-d3d4b5a92ead?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80" />
            ...
            <Box flex={1} display='flex' flexDirection={{ xs: 'column', md: 'row' }} gap="20px">
              ...
              <Box flex={1} display="flex" flexDirection="column" justifyContent="space-between" gap="30px">
                <Stack direction="column">
                  ...
                  <Typography fontSize={16} color="#11142D">Realestate Agent</Typography>
                </Stack>
                <Stack direction="column" gap="30px">
                  <Stack gap="15px">
                    ...
                    <Box display="flex" flexDirection="row" alignItems="center" gap="10px">
                      ...
                      <Typography fontSize={14} color="#11142D" >4517 Washington Ave. Manchester, kentucky 39495</Typography>
                    </Box>
                  </Stack>
                  <Stack direction="row" flexWrap="wrap" gap="20px" pb={4}>
                    <Stack flex={1} gap="15px">
                      ...
                      <Box display="flex" flexDirection="row" alignItems="conter" gap="10px">
                        <Phone sx={{ color: '#111420' }} />
