    ...
    <Box borderRadius="15px" padding="20px" bgcolor="#FCFCFC" width="fit-content">
      ...
      <Box mt="20px" display="flex" flexDirection={{ xs: 'column', lg: 'row' }} gap={4} >
        <Box flex={1} maxWidth={764}>
          <img src={propertyDetails.photo} alt={propertyDetails.title} height={546} style={{ objectFit: 'cover', aspectRatio: "1/1", borderRadius: '10px' }} className="property_details-img" />
          <Box mt="15px">
            <Stack direction="row" justifyContent="space-between" flexWrap="wrap" alignItems="center">
              <Typography fontSize={18} fontWeight={500} color="#11142D" textTransform="capitalize" style={{ color: "black" }}>{propertyDetails.propertyType} </Typography>
              <Box>
                {[1, 2, 3, 4, 5].map((star) => {
                  return (
